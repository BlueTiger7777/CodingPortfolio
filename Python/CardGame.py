...
for i in players:
	...
	match players[players.index(i)][2]:
		...
		case 5:
			print(f'Player {players.index(i)+1} got <card> Flush')
		case 6:
		...
		case 8:
			print(f'Player {players.index(i)+1} got <card> Stright Flush')
		case 9:
			print(f'Player {players.index(i)+1} got <card> Royal Flush')
